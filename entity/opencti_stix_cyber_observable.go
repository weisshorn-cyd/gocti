...
type StixCyberObservableAddInput struct {
	...
	SSHKey                   graphql.SSHKeyAddInput                   `gocti:"SSHKey"                   json:"SSHKey,omitempty"`
	AIPrompt                 graphql.AIPromptAddInput                 `gocti:"AIPrompt"                 json:"AIPrompt,omitempty"`
	IMEI                     graphql.IMEIAddInput                     `gocti:"IMEI"                     json:"IMEI,omitempty"`
	ICCID                    graphql.ICCIDAddInput                    `gocti:"ICCID"                    json:"ICCID,omitempty"`
	IMSI                     graphql.IMSIAddInput                     `gocti:"IMSI"                     json:"IMSI,omitempty"`
}
