...
type QueryVars struct {
	...
	FromIDList             []string   `json:"fromId,omitempty"`     //nolint:govet // On purpose.
	FromOrToIDList         []string   `json:"fromOrToId,omitempty"` //nolint:govet // On purpose.
	...
	ToIDList               []string   `json:"toId,omitempty"` //nolint:govet // On purpose.
