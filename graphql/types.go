...
type Case struct {
	...
	ContentsFromTemplate FileConnection                            `gocti:"contentsFromTemplate" json:"contentsFromTemplate,omitempty"`
	Templates            []Template                                `gocti:"templates"            json:"templates,omitempty"`
	TemplateAndUtils     TemplateAndUtils                          `gocti:"templateAndUtils"     json:"templateAndUtils,omitempty"`
...
type Template struct {
	...
	Content            string   `gocti:"content"              json:"content,omitempty"`
	TemplateWidgetsIDs []string `gocti:"template_widgets_ids" json:"template_widgets_ids,omitempty"`
}
...
func (t Template) MarshalJSON() ([]byte, error) {
	...
	type tempTemplate Template

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempTemplate)(&t))
}
...
type TemplateAndUtils struct {
	...
	TemplateWidgets []Widget `gocti:"template_widgets" json:"template_widgets,omitempty"`
}

func (t TemplateAndUtils) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(t).IsZero() {
		return []byte("null"), nil
	}

	type tempTemplateAndUtils TemplateAndUtils

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempTemplateAndUtils)(&t))
}
