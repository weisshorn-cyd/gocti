// Code generated by '/tools/gocti_type_generator' for OpenCTI version 7.260917.0 - DO NOT EDIT.
...
// AIPrompt represents a GraphQL OBJECT
...
type AIPrompt struct {
	...
	Metrics     []Metric `gocti:"metrics"      json:"metrics,omitempty"`
	...
	RefreshedAt        *time.Time   `gocti:"refreshed_at"          json:"refreshed_at,omitempty"`
	XOpenctiModifiedAt *time.Time   `gocti:"x_opencti_modified_at" json:"x_opencti_modified_at,omitempty"`
...
func (a AIPrompt) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(a).IsZero() {
		return []byte("null"), nil
	}

	type tempAIPrompt AIPrompt

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempAIPrompt)(&a))
}

// AIPromptAddInput represents a GraphQL INPUT_OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type AIPromptAddInput struct {
	// AIPromptAddInput
	Value            string      `gocti:"value"            json:"value,omitempty"`
	File             []byte      `gocti:"file"             json:"file,omitempty"`
	FileMarkings     []string    `gocti:"fileMarkings"     json:"fileMarkings,omitempty"`
	Files            [][]byte    `gocti:"files"            json:"files,omitempty"`
	FilesMarkings    []string    `gocti:"filesMarkings"    json:"filesMarkings,omitempty"`
	NoTriggerImport  bool        `gocti:"noTriggerImport"  json:"noTriggerImport,omitempty"`
	UpsertOperations []EditInput `gocti:"upsertOperations" json:"upsertOperations,omitempty"`
}

func (a AIPromptAddInput) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(a).IsZero() {
		return []byte("null"), nil
	}

	type tempAIPromptAddInput AIPromptAddInput

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempAIPromptAddInput)(&a))
}
...
type AdministrativeArea struct {
	...
	WorkflowInstance  WorkflowInstance `gocti:"workflowInstance"  json:"workflowInstance,omitempty"`
	PirInformation    PirInformation   `gocti:"pirInformation"    json:"pirInformation,omitempty"`
...
// ApiToken represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type ApiToken struct {
	...
	Name        string     `gocti:"name"         json:"name,omitempty"`
	CreatedAt   *time.Time `gocti:"created_at"   json:"created_at,omitempty"`
	ExpiresAt   *time.Time `gocti:"expires_at"   json:"expires_at,omitempty"`
	MaskedToken string     `gocti:"masked_token" json:"masked_token,omitempty"`
	LastUsedAt  *time.Time `gocti:"last_used_at" json:"last_used_at,omitempty"`
}
...
func (a ApiToken) MarshalJSON() ([]byte, error) {
	...
	type tempApiToken ApiToken

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempApiToken)(&a))
}
...
type ArtifactAddInput struct {
	...
	FilesMarkings           []string    `gocti:"filesMarkings"              json:"filesMarkings,omitempty"`
	NoTriggerImport         []bool      `gocti:"noTriggerImport"            json:"noTriggerImport,omitempty"`
	Embedded                []bool      `gocti:"embedded"                   json:"embedded,omitempty"`
	UpsertOperations        []EditInput `gocti:"upsertOperations"           json:"upsertOperations,omitempty"`
}
...
// AttackPatternCoverage represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type AttackPatternCoverage struct {
	// AttackPatternCoverage
	RelationshipID      string           `gocti:"relationship_id"      json:"relationship_id,omitempty"`
	CoverageInformation []CoverageResult `gocti:"coverage_information" json:"coverage_information,omitempty"`
	To                  AttackPattern    `gocti:"to"                   json:"to,omitempty"`
}

func (a AttackPatternCoverage) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(a).IsZero() {
		return []byte("null"), nil
	}

	type tempAttackPatternCoverage AttackPatternCoverage

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempAttackPatternCoverage)(&a))
}

// AttackPatternCoverages represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type AttackPatternCoverages struct {
	// AttackPatternCoverages
	Count    int                     `gocti:"count"    json:"count,omitempty"`
	Entities []AttackPatternCoverage `gocti:"entities" json:"entities,omitempty"`
}

func (a AttackPatternCoverages) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(a).IsZero() {
		return []byte("null"), nil
	}

	type tempAttackPatternCoverages AttackPatternCoverages

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempAttackPatternCoverages)(&a))
}
...
type Campaign struct {
	...
	SecurityCoverage SecurityCoverage `gocti:"securityCoverage" json:"securityCoverage,omitempty"`
}
...
type CaseIncident struct {
	...
	CustomFieldValues []CustomFieldValue `gocti:"customFieldValues" json:"customFieldValues,omitempty"`
}
...
type Connector struct {
	...
	AutoUpdate                   bool                           `gocti:"auto_update"                    json:"auto_update,omitempty"`
	EnrichmentResolution         string                         `gocti:"enrichment_resolution"          json:"enrichment_resolution,omitempty"`
	...
	ConnectorPriorityGroup       ConnectorPriorityGroup         `gocti:"connector_priority_group"       json:"connector_priority_group,omitempty"`
	UpdatedAt                    *time.Time                     `gocti:"updated_at"                     json:"updated_at,omitempty"`
	RefreshedAt                  *time.Time                     `gocti:"refreshed_at"                   json:"refreshed_at,omitempty"`
	CreatedAt                    *time.Time                     `gocti:"created_at"                     json:"created_at,omitempty"`
	...
	ManagerContractExcerpt       ManagerContractExcerpt         `gocti:"manager_contract_excerpt"       json:"manager_contract_excerpt,omitempty"`
	...
	ManagerHealthMetrics         ConnectorHealthMetrics         `gocti:"manager_health_metrics"         json:"manager_health_metrics,omitempty"`
	ManagerConnectorUptime       int                            `gocti:"manager_connector_uptime"       json:"manager_connector_uptime,omitempty"`
	...
	XtmOneIntent                 string                         `gocti:"xtm_one_intent"                 json:"xtm_one_intent,omitempty"`
	Jwks                         string                         `gocti:"jwks"                           json:"jwks,omitempty"`
}
...
type ConnectorConfig struct {
	...
	S3                S3Connection       `gocti:"s3"                  json:"s3,omitempty"`
	...
	DeadLetterRouting string             `gocti:"dead_letter_routing" json:"dead_letter_routing,omitempty"`
}
...
// ConnectorHealthMetrics represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type ConnectorHealthMetrics struct {
	// ConnectorHealthMetrics
	RestartCount   int        `gocti:"restart_count"     json:"restart_count,omitempty"`
	StartedAt      *time.Time `gocti:"started_at"        json:"started_at,omitempty"`
	LastUpdate     *time.Time `gocti:"last_update"       json:"last_update,omitempty"`
	IsInRebootLoop bool       `gocti:"is_in_reboot_loop" json:"is_in_reboot_loop,omitempty"`
}

func (c ConnectorHealthMetrics) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(c).IsZero() {
		return []byte("null"), nil
	}

	type tempConnectorHealthMetrics ConnectorHealthMetrics

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempConnectorHealthMetrics)(&c))
}
...
type ConnectorPriorityGroup string

const (
	ConnectorPriorityGroupREALTIME ConnectorPriorityGroup = "REALTIME"
	ConnectorPriorityGroupDEFAULT  ConnectorPriorityGroup = "DEFAULT"
)

func (c ConnectorPriorityGroup) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(c).IsZero() {
		return []byte("null"), nil
	}

	type tempConnectorPriorityGroup ConnectorPriorityGroup

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempConnectorPriorityGroup)(&c))
}
...
// CoverageResult represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type CoverageResult struct {
	// CoverageResult
	CoverageName  string `gocti:"coverage_name"  json:"coverage_name,omitempty"`
	CoverageScore int    `gocti:"coverage_score" json:"coverage_score,omitempty"`
}

func (c CoverageResult) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(c).IsZero() {
		return []byte("null"), nil
	}

	type tempCoverageResult CoverageResult

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempCoverageResult)(&c))
}
...
// CustomFieldValue represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type CustomFieldValue struct {
	// CustomFieldValue
	FieldID      string     `gocti:"field_id"      json:"field_id,omitempty"`
	FieldName    string     `gocti:"field_name"    json:"field_name,omitempty"`
	IntValue     int        `gocti:"int_value"     json:"int_value,omitempty"`
	StringValue  string     `gocti:"string_value"  json:"string_value,omitempty"`
	BooleanValue bool       `gocti:"boolean_value" json:"boolean_value,omitempty"`
	DateValue    *time.Time `gocti:"date_value"    json:"date_value,omitempty"`
	SelectValue  string     `gocti:"select_value"  json:"select_value,omitempty"`
	SelectValues []string   `gocti:"select_values" json:"select_values,omitempty"`
}
...
func (c CustomFieldValue) MarshalJSON() ([]byte, error) {
	...
	type tempCustomFieldValue CustomFieldValue

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempCustomFieldValue)(&c))
}

// CustomFieldValueAddInput represents a GraphQL INPUT_OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type CustomFieldValueAddInput struct {
...
func (c CustomFieldValueAddInput) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(c).IsZero() {
		return []byte("null"), nil
	}

	type tempCustomFieldValueAddInput CustomFieldValueAddInput

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempCustomFieldValueAddInput)(&c))
}

// CustomView represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type CustomView struct {
	...
	Name                  string     `gocti:"name"                  json:"name,omitempty"`
	Description           string     `gocti:"description"           json:"description,omitempty"`
	Slug                  string     `gocti:"slug"                  json:"slug,omitempty"`
	Manifest              string     `gocti:"manifest"              json:"manifest,omitempty"`
	Path                  string     `gocti:"path"                  json:"path,omitempty"`
	TargetEntityType      string     `gocti:"targetEntityType"      json:"targetEntityType,omitempty"`
	Enabled               bool       `gocti:"enabled"               json:"enabled,omitempty"`
	Default               bool       `gocti:"default"               json:"default,omitempty"`
	ToWidgetExport        string     `gocti:"toWidgetExport"        json:"toWidgetExport,omitempty"`
	ToConfigurationExport string     `gocti:"toConfigurationExport" json:"toConfigurationExport,omitempty"`
}

func (c CustomView) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(c).IsZero() {
		return []byte("null"), nil
	}

	type tempCustomView CustomView

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempCustomView)(&c))
}
...
// Distribution represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type Distribution struct {
	// Distribution
	Label  string                                `gocti:"label"  json:"label,omitempty"`
	Entity StixObjectOrStixRelationshipOrCreator `gocti:"entity" json:"entity,omitempty"`
	Value  int                                   `gocti:"value"  json:"value,omitempty"`
}
...
func (d Distribution) MarshalJSON() ([]byte, error) {
	...
	type tempDistribution Distribution

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempDistribution)(&d))
}
...
// DraftObjectsCount represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type DraftObjectsCount struct {
	// DraftObjectsCount
	TotalCount         int `gocti:"totalCount"         json:"totalCount,omitempty"`
	EntitiesCount      int `gocti:"entitiesCount"      json:"entitiesCount,omitempty"`
	ObservablesCount   int `gocti:"observablesCount"   json:"observablesCount,omitempty"`
	RelationshipsCount int `gocti:"relationshipsCount" json:"relationshipsCount,omitempty"`
	SightingsCount     int `gocti:"sightingsCount"     json:"sightingsCount,omitempty"`
	ContainersCount    int `gocti:"containersCount"    json:"containersCount,omitempty"`
	ReviewsCount       int `gocti:"reviewsCount"       json:"reviewsCount,omitempty"`
}

func (d DraftObjectsCount) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(d).IsZero() {
		return []byte("null"), nil
	}

	type tempDraftObjectsCount DraftObjectsCount

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempDraftObjectsCount)(&d))
}
...
const (
	DraftStatusOpen      DraftStatus = "open"
	DraftStatusValidated DraftStatus = "validated"
)

func (d DraftStatus) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(d).IsZero() {
		return []byte("null"), nil
	}

	type tempDraftStatus DraftStatus

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempDraftStatus)(&d))
}
...
type DraftVersion struct {
	...
	DraftUpdatesPatch string         `gocti:"draft_updates_patch" json:"draft_updates_patch,omitempty"`
}
...
// DraftWorkspace represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type DraftWorkspace struct {
	// InternalObject
	ID             string         `gocti:"id"             json:"id,omitempty"`
	EntityType     string         `gocti:"entity_type"    json:"entity_type,omitempty"`
	Representative Representative `gocti:"representative" json:"representative,omitempty"`
	...
	ObjectAssignee         []Assignee        `gocti:"objectAssignee"         json:"objectAssignee,omitempty"`
	ObjectParticipant      []Participant     `gocti:"objectParticipant"      json:"objectParticipant,omitempty"`
	ObjectsCount           DraftObjectsCount `gocti:"objectsCount"           json:"objectsCount,omitempty"`
	DraftStatus            DraftStatus       `gocti:"draft_status"           json:"draft_status,omitempty"`
	ProcessingCount        int               `gocti:"processingCount"        json:"processingCount,omitempty"`
	Works                  []Work            `gocti:"works"                  json:"works,omitempty"`
	ValidationWork         Work              `gocti:"validationWork"         json:"validationWork,omitempty"`
	AuthorizedMembers      []MemberAccess    `gocti:"authorizedMembers"      json:"authorizedMembers,omitempty"`
	CurrentUserAccessRight string            `gocti:"currentUserAccessRight" json:"currentUserAccessRight,omitempty"`
}

func (d DraftWorkspace) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(d).IsZero() {
		return []byte("null"), nil
	}

	type tempDraftWorkspace DraftWorkspace

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempDraftWorkspace)(&d))
}

// EditInput represents a GraphQL INPUT_OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type EditInput struct {
	// EditInput
	Key        string        `gocti:"key"         json:"key,omitempty"`
	ObjectPath string        `gocti:"object_path" json:"object_path,omitempty"`
	Value      []any         `gocti:"value"       json:"value,omitempty"`
	Operation  EditOperation `gocti:"operation"   json:"operation,omitempty"`
}

func (e EditInput) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(e).IsZero() {
		return []byte("null"), nil
	}

	type tempEditInput EditInput

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempEditInput)(&e))
}
...
func (e EditOperation) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(e).IsZero() {
		return []byte("null"), nil
	}

	type tempEditOperation EditOperation

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempEditOperation)(&e))
}
...
type EntitySetting struct {
	...
	// EntitySetting
	WorkflowConfiguration       bool                          `gocti:"workflow_configuration"        json:"workflow_configuration,omitempty"`
	WorkflowID                  string                        `gocti:"workflow_id"                   json:"workflow_id,omitempty"`
	WorkflowPublishedVersionID  string                        `gocti:"workflow_published_version_id" json:"workflow_published_version_id,omitempty"`
	...
	SyncWorkflowStatusByName    bool                          `gocti:"sync_workflow_status_by_name"  json:"sync_workflow_status_by_name,omitempty"`
...
type FileMetadata struct {
	...
	FintelTemplateID      string        `gocti:"fintel_template_id"      json:"fintel_template_id,omitempty"`
}
...
type FintelTemplate struct {
	...
	ToConfigurationExport     string                 `gocti:"toConfigurationExport"     json:"toConfigurationExport,omitempty"`
	Default                   bool                   `gocti:"default"                   json:"default,omitempty"`
	IncludeCoverPageByDefault bool                   `gocti:"includeCoverPageByDefault" json:"includeCoverPageByDefault,omitempty"`
	IncludeBackPageByDefault  bool                   `gocti:"includeBackPageByDefault"  json:"includeBackPageByDefault,omitempty"`
}
...
// ICCID represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type ICCID struct {
	// BasicObject
...
func (i ICCID) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(i).IsZero() {
		return []byte("null"), nil
	}

	type tempICCID ICCID

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempICCID)(&i))
}

// ICCIDAddInput represents a GraphQL INPUT_OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type ICCIDAddInput struct {
	// ICCIDAddInput
	Value string `gocti:"value" json:"value,omitempty"`
	File  []byte `gocti:"file"  json:"file,omitempty"`
}

func (i ICCIDAddInput) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(i).IsZero() {
		return []byte("null"), nil
	}

	type tempICCIDAddInput ICCIDAddInput

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempICCIDAddInput)(&i))
}

// IMEI represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type IMEI struct {
	// BasicObject
...
func (i IMEI) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(i).IsZero() {
		return []byte("null"), nil
	}
	...
	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempIMEI)(&i))
}

// IMEIAddInput represents a GraphQL INPUT_OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type IMEIAddInput struct {
	// IMEIAddInput
	Value string `gocti:"value" json:"value,omitempty"`
	File  []byte `gocti:"file"  json:"file,omitempty"`
}

func (i IMEIAddInput) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(i).IsZero() {
		return []byte("null"), nil
	}

	type tempIMEIAddInput IMEIAddInput

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempIMEIAddInput)(&i))
}

// IMSI represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type IMSI struct {
	// BasicObject
...
func (i IMSI) MarshalJSON() ([]byte, error) {
	...
	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempIMSI)(&i))
}

// IMSIAddInput represents a GraphQL INPUT_OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type IMSIAddInput struct {
	// IMSIAddInput
	Value string `gocti:"value" json:"value,omitempty"`
	File  []byte `gocti:"file"  json:"file,omitempty"`
}

func (i IMSIAddInput) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(i).IsZero() {
		return []byte("null"), nil
	}

	type tempIMSIAddInput IMSIAddInput

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempIMSIAddInput)(&i))
}
...
type Indicator struct {
	...
	DecayExclusionAppliedRule  IndicatorDecayExclusionRule   `gocti:"decay_exclusion_applied_rule"   json:"decay_exclusion_applied_rule,omitempty"`
...
// IndicatorDecayExclusionRule represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type IndicatorDecayExclusionRule struct {
	// IndicatorDecayExclusionRule
	DecayExclusionID        string     `gocti:"decay_exclusion_id"         json:"decay_exclusion_id,omitempty"`
	DecayExclusionName      string     `gocti:"decay_exclusion_name"       json:"decay_exclusion_name,omitempty"`
	DecayExclusionCreatedAt *time.Time `gocti:"decay_exclusion_created_at" json:"decay_exclusion_created_at,omitempty"`
	DecayExclusionFilters   string     `gocti:"decay_exclusion_filters"    json:"decay_exclusion_filters,omitempty"`
}

func (i IndicatorDecayExclusionRule) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(i).IsZero() {
		return []byte("null"), nil
	}

	type tempIndicatorDecayExclusionRule IndicatorDecayExclusionRule

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempIndicatorDecayExclusionRule)(&i))
}
...
// ManagerContractExcerpt represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type ManagerContractExcerpt struct {
	// ManagerContractExcerpt
	Title string `gocti:"title" json:"title,omitempty"`
	Slug  string `gocti:"slug"  json:"slug,omitempty"`
	Logo  string `gocti:"logo"  json:"logo,omitempty"`
}

func (m ManagerContractExcerpt) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(m).IsZero() {
		return []byte("null"), nil
	}

	type tempManagerContractExcerpt ManagerContractExcerpt

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempManagerContractExcerpt)(&m))
}
...
// Metric represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type Metric struct {
	// Metric
	Name  string  `gocti:"name"  json:"name,omitempty"`
	Value float64 `gocti:"value" json:"value,omitempty"`
}
...
func (m Metric) MarshalJSON() ([]byte, error) {
	...
	type tempMetric Metric

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempMetric)(&m))
}
...
type NetworkTraffic struct {
	...
	SrcRef       int        `gocti:"src_ref"        json:"src_ref,omitempty"`
	DstRef       int        `gocti:"dst_ref"        json:"dst_ref,omitempty"`
...
type Organization struct {
	...
	DefaultDashboard                Workspace              `gocti:"default_dashboard"                  json:"default_dashboard,omitempty"`
	DefaultHiddenTypes              []string               `gocti:"default_hidden_types"               json:"default_hidden_types,omitempty"`
	RestrictAccess                  bool                   `gocti:"restrict_access"                    json:"restrict_access,omitempty"`
}
...
type Pir struct {
	...
	Creators               []Creator           `gocti:"creators"               json:"creators,omitempty"`
	Name                   string              `gocti:"name"                   json:"name,omitempty"`
	PirType                PirType             `gocti:"pir_type"               json:"pir_type,omitempty"`
	Description            string              `gocti:"description"            json:"description,omitempty"`
	...
	AuthorizedMembers      []MemberAccess      `gocti:"authorizedMembers"      json:"authorizedMembers,omitempty"`
	CurrentUserAccessRight string              `gocti:"currentUserAccessRight" json:"currentUserAccessRight,omitempty"`
	PirContainers          ContainerConnection `gocti:"pirContainers"          json:"pirContainers,omitempty"`
	QueueMessages          int                 `gocti:"queue_messages"         json:"queue_messages,omitempty"`
}
...
// PirDependency represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type PirDependency struct {
	// PirDependency
	ElementID string `gocti:"element_id" json:"element_id,omitempty"`
	AuthorID  string `gocti:"author_id"  json:"author_id,omitempty"`
}

func (p PirDependency) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(p).IsZero() {
		return []byte("null"), nil
	}

	type tempPirDependency PirDependency

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempPirDependency)(&p))
}
...
type PirExplanation struct {
	// PirExplanation
	Dependencies []PirDependency `gocti:"dependencies" json:"dependencies,omitempty"`
...
// PirInformation represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type PirInformation struct {
	// PirInformation
	PirScore         int              `gocti:"pir_score"           json:"pir_score,omitempty"`
	LastPirScoreDate *time.Time       `gocti:"last_pir_score_date" json:"last_pir_score_date,omitempty"`
	PirExplanation   []PirExplanation `gocti:"pir_explanation"     json:"pir_explanation,omitempty"`
}

func (p PirInformation) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(p).IsZero() {
		return []byte("null"), nil
	}

	type tempPirInformation PirInformation

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempPirInformation)(&p))
}

type PirType string

const (
	PirTypeTHREATLANDSCAPE PirType = "THREAT_LANDSCAPE"
	PirTypeTHREATORIGIN    PirType = "THREAT_ORIGIN"
	PirTypeTHREATCUSTOM    PirType = "THREAT_CUSTOM"
)

func (p PirType) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(p).IsZero() {
		return []byte("null"), nil
	}

	type tempPirType PirType

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempPirType)(&p))
}
...
type Role struct {
	...
	CapabilitiesInDraft      []Capability      `gocti:"capabilitiesInDraft"         json:"capabilitiesInDraft,omitempty"`
	EditContext              []EditUserContext `gocti:"editContext"                 json:"editContext,omitempty"`
...
// S3Connection represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type S3Connection struct {
	// S3Connection
	Endpoint     string `gocti:"endpoint"      json:"endpoint,omitempty"`
	Port         int    `gocti:"port"          json:"port,omitempty"`
	UseSsl       bool   `gocti:"use_ssl"       json:"use_ssl,omitempty"`
	BucketName   string `gocti:"bucket_name"   json:"bucket_name,omitempty"`
	BucketRegion string `gocti:"bucket_region" json:"bucket_region,omitempty"`
	AccessKey    string `gocti:"access_key"    json:"access_key,omitempty"`
	SecretKey    string `gocti:"secret_key"    json:"secret_key,omitempty"`
}

func (s S3Connection) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(s).IsZero() {
		return []byte("null"), nil
	}

	type tempS3Connection S3Connection

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempS3Connection)(&s))
}

// SSHKey represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type SSHKey struct {
	// BasicObject
	...
	// SSHKey
	KeyType           string     `gocti:"key_type"           json:"key_type,omitempty"`
	PublicKey         string     `gocti:"public_key"         json:"public_key,omitempty"`
	FingerprintSha256 string     `gocti:"fingerprint_sha256" json:"fingerprint_sha256,omitempty"`
	FingerprintMd5    string     `gocti:"fingerprint_md5"    json:"fingerprint_md5,omitempty"`
	KeyLength         string     `gocti:"key_length"         json:"key_length,omitempty"`
	ExpirationDate    *time.Time `gocti:"expiration_date"    json:"expiration_date,omitempty"`
	Comment           string     `gocti:"comment"            json:"comment,omitempty"`
	Created           *time.Time `gocti:"created"            json:"created,omitempty"`
}
...
func (s SSHKey) MarshalJSON() ([]byte, error) {
	...
	type tempSSHKey SSHKey

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempSSHKey)(&s))
}

// SSHKeyAddInput represents a GraphQL INPUT_OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
...
func (s SSHKeyAddInput) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(s).IsZero() {
		return []byte("null"), nil
	}

	type tempSSHKeyAddInput SSHKeyAddInput

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempSSHKeyAddInput)(&s))
}

// SavedFilter represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type SavedFilter struct {
	...
	Name                   string         `gocti:"name"                   json:"name,omitempty"`
	Filters                string         `gocti:"filters"                json:"filters,omitempty"`
	Scope                  string         `gocti:"scope"                  json:"scope,omitempty"`
	CreatorID              string         `gocti:"creator_id"             json:"creator_id,omitempty"`
	AuthorizedMembers      []MemberAccess `gocti:"authorizedMembers"      json:"authorizedMembers,omitempty"`
	CurrentUserAccessRight string         `gocti:"currentUserAccessRight" json:"currentUserAccessRight,omitempty"`
}
...
func (s SavedFilter) MarshalJSON() ([]byte, error) {
	...
	type tempSavedFilter SavedFilter

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempSavedFilter)(&s))
}
...
// SecurityCoverage represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type SecurityCoverage struct {
	...
	// SecurityCoverage
	StixCoreRelationshipsFromResults StixCoreRelationshipConnection `gocti:"stixCoreRelationshipsFromResults" json:"stixCoreRelationshipsFromResults,omitempty"`
	CoveredAttackPatterns            AttackPatternCoverages         `gocti:"coveredAttackPatterns"            json:"coveredAttackPatterns,omitempty"`
	CoveredVulnerabilities           VulnerabilityCoverages         `gocti:"coveredVulnerabilities"           json:"coveredVulnerabilities,omitempty"`
	CoveredEntitiesDistribution      []Distribution                 `gocti:"coveredEntitiesDistribution"      json:"coveredEntitiesDistribution,omitempty"`
	IdentityClass                    string                         `gocti:"identity_class"                   json:"identity_class,omitempty"`
	Name                             string                         `gocti:"name"                             json:"name,omitempty"`
	Description                      string                         `gocti:"description"                      json:"description,omitempty"`
	ContactInformation               string                         `gocti:"contact_information"              json:"contact_information,omitempty"`
	...
	XOpenctiAliases                  []string                       `gocti:"x_opencti_aliases"                json:"x_opencti_aliases,omitempty"`
	XOpenctiReliability              string                         `gocti:"x_opencti_reliability"            json:"x_opencti_reliability,omitempty"`
	CoverageLastResult               *time.Time                     `gocti:"coverage_last_result"             json:"coverage_last_result,omitempty"`
	CoverageValidFrom                *time.Time                     `gocti:"coverage_valid_from"              json:"coverage_valid_from,omitempty"`
	CoverageValidTo                  *time.Time                     `gocti:"coverage_valid_to"                json:"coverage_valid_to,omitempty"`
	CoverageInformation              []CoverageResult               `gocti:"coverage_information"             json:"coverage_information,omitempty"`
	ExternalUri                      string                         `gocti:"external_uri"                     json:"external_uri,omitempty"`
	Periodicity                      string                         `gocti:"periodicity"                      json:"periodicity,omitempty"`
	Duration                         string                         `gocti:"duration"                         json:"duration,omitempty"`
	TypeAffinity                     string                         `gocti:"type_affinity"                    json:"type_affinity,omitempty"`
	PlatformsAffinity                []string                       `gocti:"platforms_affinity"               json:"platforms_affinity,omitempty"`
	AutoEnrichmentDisable            bool                           `gocti:"auto_enrichment_disable"          json:"auto_enrichment_disable,omitempty"`
	ObjectCovered                    StixDomainObject               `gocti:"objectCovered"                    json:"objectCovered,omitempty"`
	ToStixBundle                     string                         `gocti:"toStixBundle"                     json:"toStixBundle,omitempty"`
	SecurityPlatformType             string                         `gocti:"security_platform_type"           json:"security_platform_type,omitempty"`
	Results                          []SecurityCoverageResult       `gocti:"results"                          json:"results,omitempty"`
}

func (s SecurityCoverage) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(s).IsZero() {
		return []byte("null"), nil
	}

	type tempSecurityCoverage SecurityCoverage

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempSecurityCoverage)(&s))
}

// SecurityCoverageExpectation represents a GraphQL INPUT_OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type SecurityCoverageExpectation struct {
	// SecurityCoverageExpectation
	CoverageName  string `gocti:"coverage_name"  json:"coverage_name,omitempty"`
	CoverageScore int    `gocti:"coverage_score" json:"coverage_score,omitempty"`
}

func (s SecurityCoverageExpectation) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(s).IsZero() {
		return []byte("null"), nil
	}

	type tempSecurityCoverageExpectation SecurityCoverageExpectation

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempSecurityCoverageExpectation)(&s))
}

// SecurityCoverageResult represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type SecurityCoverageResult struct {
	...
	CoverageInformation []CoverageResult `gocti:"coverage_information"  json:"coverage_information,omitempty"`
	ExternalUri         string           `gocti:"external_uri"          json:"external_uri,omitempty"`
	ResultOf            SecurityCoverage `gocti:"resultOf"              json:"resultOf,omitempty"`
}

func (s SecurityCoverageResult) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(s).IsZero() {
		return []byte("null"), nil
	}

	type tempSecurityCoverageResult SecurityCoverageResult

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempSecurityCoverageResult)(&s))
}
...
func (s SsvcAutomatable) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(s).IsZero() {
		return []byte("null"), nil
	}

	type tempSsvcAutomatable SsvcAutomatable

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempSsvcAutomatable)(&s))
}
...
func (s SsvcExploitation) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(s).IsZero() {
		return []byte("null"), nil
	}

	type tempSsvcExploitation SsvcExploitation

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempSsvcExploitation)(&s))
}
...
func (s SsvcTechnicalImpact) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(s).IsZero() {
		return []byte("null"), nil
	}

	type tempSsvcTechnicalImpact SsvcTechnicalImpact

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempSsvcTechnicalImpact)(&s))
}
...
type Status struct {
	...
	ToBeDeletedAt *time.Time     `gocti:"to_be_deleted_at" json:"to_be_deleted_at,omitempty"`
}
...
func (s StixCoreObject) Implementations() []reflect.Type {
	return []reflect.Type{
		...
		reflect.TypeFor[SSHKey](),
		reflect.TypeFor[AIPrompt](),
		reflect.TypeFor[IMEI](),
		reflect.TypeFor[ICCID](),
		reflect.TypeFor[IMSI](),
		...
		reflect.TypeFor[Organization](),
		reflect.TypeFor[SecurityPlatform](),
		reflect.TypeFor[SecurityCoverage](),
		reflect.TypeFor[SecurityCoverageResult](),
	}
}
...
func (s StixObjectOrStixRelationship) Implementations() []reflect.Type {
	return []reflect.Type{
		...
		reflect.TypeFor[SecurityCoverage](),
		reflect.TypeFor[SecurityCoverageResult](),
		reflect.TypeFor[CustomView](),
		reflect.TypeFor[IMEI](),
		reflect.TypeFor[ICCID](),
		reflect.TypeFor[IMSI](),
		reflect.TypeFor[SavedFilter](),
	}
}
...
func (s StixObjectOrStixRelationshipOrCreator) Implementations() []reflect.Type {
	return []reflect.Type{
		...
		reflect.TypeFor[SavedFilter](),
		reflect.TypeFor[Vocabulary](),
		reflect.TypeFor[DraftWorkspace](),
	}
}
...
// Theme represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type Theme struct {
	// InternalObject
	...
	// Theme
	Name                         string `gocti:"name"                             json:"name,omitempty"`
	ThemeBackground              string `gocti:"theme_background"                 json:"theme_background,omitempty"`
	ThemePaper                   string `gocti:"theme_paper"                      json:"theme_paper,omitempty"`
	ThemeNav                     string `gocti:"theme_nav"                        json:"theme_nav,omitempty"`
	ThemePrimary                 string `gocti:"theme_primary"                    json:"theme_primary,omitempty"`
	ThemeSecondary               string `gocti:"theme_secondary"                  json:"theme_secondary,omitempty"`
	ThemeAccent                  string `gocti:"theme_accent"                     json:"theme_accent,omitempty"`
	ThemeLogo                    string `gocti:"theme_logo"                       json:"theme_logo,omitempty"`
	ThemeLogoCollapsed           string `gocti:"theme_logo_collapsed"             json:"theme_logo_collapsed,omitempty"`
	ThemeLogoLogin               string `gocti:"theme_logo_login"                 json:"theme_logo_login,omitempty"`
	ThemeTextColor               string `gocti:"theme_text_color"                 json:"theme_text_color,omitempty"`
	ThemeLoginAsideColor         string `gocti:"theme_login_aside_color"          json:"theme_login_aside_color,omitempty"`
	ThemeLoginAsideGradientStart string `gocti:"theme_login_aside_gradient_start" json:"theme_login_aside_gradient_start,omitempty"`
	ThemeLoginAsideGradientEnd   string `gocti:"theme_login_aside_gradient_end"   json:"theme_login_aside_gradient_end,omitempty"`
	ThemeLoginAsideImage         string `gocti:"theme_login_aside_image"          json:"theme_login_aside_image,omitempty"`
	ToConfigurationExport        string `gocti:"toConfigurationExport"            json:"toConfigurationExport,omitempty"`
	BuiltIn                      bool   `gocti:"built_in"                         json:"built_in,omitempty"`
}
...
func (t Theme) MarshalJSON() ([]byte, error) {
	...
	type tempTheme Theme

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempTheme)(&t))
}
...
type TypeAttribute struct {
	...
	Multiple      bool           `gocti:"multiple"      json:"multiple,omitempty"`
	Upsert        bool           `gocti:"upsert"        json:"upsert,omitempty"`
	Label         string         `gocti:"label"         json:"label,omitempty"`
	DefaultValues []DefaultValue `gocti:"defaultValues" json:"defaultValues,omitempty"`
	Scale         string         `gocti:"scale"         json:"scale,omitempty"`
}
...
type User struct {
	...
	ApiTokens                  []ApiToken               `gocti:"api_tokens"                   json:"api_tokens,omitempty"`
	...
	PasswordValidUntil         *time.Time               `gocti:"password_valid_until"         json:"password_valid_until,omitempty"`
	UserServiceAccount         bool                     `gocti:"user_service_account"         json:"user_service_account,omitempty"`
	...
	UnsubscribedNewsFeedTypes  []string                 `gocti:"unsubscribed_news_feed_types" json:"unsubscribed_news_feed_types,omitempty"`
	EditContext                []EditUserContext        `gocti:"editContext"                  json:"editContext,omitempty"`
	Creator                    Creator                  `gocti:"creator"                      json:"creator,omitempty"`
}
...
type Vulnerability struct {
	...
	XOpenctiSsvcExploitation             SsvcExploitation              `gocti:"x_opencti_ssvc_exploitation"                json:"x_opencti_ssvc_exploitation,omitempty"`
	XOpenctiSsvcAutomatable              SsvcAutomatable               `gocti:"x_opencti_ssvc_automatable"                 json:"x_opencti_ssvc_automatable,omitempty"`
	XOpenctiSsvcTechnicalImpact          SsvcTechnicalImpact           `gocti:"x_opencti_ssvc_technical_impact"            json:"x_opencti_ssvc_technical_impact,omitempty"`
...
// VulnerabilityCoverage represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type VulnerabilityCoverage struct {
	...
	RelationshipID      string           `gocti:"relationship_id"      json:"relationship_id,omitempty"`
	CoverageInformation []CoverageResult `gocti:"coverage_information" json:"coverage_information,omitempty"`
	To                  Vulnerability    `gocti:"to"                   json:"to,omitempty"`
}

func (v VulnerabilityCoverage) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(v).IsZero() {
		return []byte("null"), nil
	}

	type tempVulnerabilityCoverage VulnerabilityCoverage

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempVulnerabilityCoverage)(&v))
}

// VulnerabilityCoverages represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type VulnerabilityCoverages struct {
	// VulnerabilityCoverages
	Count    int                     `gocti:"count"    json:"count,omitempty"`
	Entities []VulnerabilityCoverage `gocti:"entities" json:"entities,omitempty"`
}

func (v VulnerabilityCoverages) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(v).IsZero() {
		return []byte("null"), nil
	}

	type tempVulnerabilityCoverages VulnerabilityCoverages

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempVulnerabilityCoverages)(&v))
}
...
type WidgetDataSelection struct {
	...
	FiltersID     string            `gocti:"filters_id"     json:"filters_id,omitempty"`
	DynamicFromID string            `gocti:"dynamicFrom_id" json:"dynamicFrom_id,omitempty"`
	DynamicToID   string            `gocti:"dynamicTo_id"   json:"dynamicTo_id,omitempty"`
...
// WorkflowActionConfig represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type WorkflowActionConfig struct {
	// WorkflowActionConfig
	Type   string `gocti:"type"   json:"type,omitempty"`
	Params string `gocti:"params" json:"params,omitempty"`
}

func (w WorkflowActionConfig) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(w).IsZero() {
		return []byte("null"), nil
	}

	type tempWorkflowActionConfig WorkflowActionConfig

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempWorkflowActionConfig)(&w))
}

// WorkflowActionError represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type WorkflowActionError struct {
	// WorkflowActionError
	Timestamp *time.Time `gocti:"timestamp" json:"timestamp,omitempty"`
	Message   string     `gocti:"message"   json:"message,omitempty"`
	Source    string     `gocti:"source"    json:"source,omitempty"`
...
func (w WorkflowActionError) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(w).IsZero() {
		return []byte("null"), nil
	}

	type tempWorkflowActionError WorkflowActionError

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempWorkflowActionError)(&w))
}
...
func (w WorkflowExecutionStatus) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(w).IsZero() {
		return []byte("null"), nil
	}

	type tempWorkflowExecutionStatus WorkflowExecutionStatus

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempWorkflowExecutionStatus)(&w))
}

// WorkflowInstance represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type WorkflowInstance struct {
	// WorkflowInstance
	ID                 string                    `gocti:"id"                 json:"id,omitempty"`
	CurrentState       string                    `gocti:"currentState"       json:"currentState,omitempty"`
	CurrentStatus      Status                    `gocti:"currentStatus"      json:"currentStatus,omitempty"`
	AllowedTransitions []WorkflowTransition      `gocti:"allowedTransitions" json:"allowedTransitions,omitempty"`
	LastHistoryEntry   WorkflowLastHistoryEntry  `gocti:"lastHistoryEntry"   json:"lastHistoryEntry,omitempty"`
	PendingStatus      WorkflowExecutionStatus   `gocti:"pendingStatus"      json:"pendingStatus,omitempty"`
	PendingError       string                    `gocti:"pendingError"       json:"pendingError,omitempty"`
	PendingTransition  WorkflowPendingTransition `gocti:"pendingTransition"  json:"pendingTransition,omitempty"`
}
...
func (w WorkflowInstance) MarshalJSON() ([]byte, error) {
	...
	type tempWorkflowInstance WorkflowInstance

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempWorkflowInstance)(&w))
}

// WorkflowLastHistoryEntry represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type WorkflowLastHistoryEntry struct {
	// WorkflowLastHistoryEntry
	State     string `gocti:"state"     json:"state,omitempty"`
	Event     string `gocti:"event"     json:"event,omitempty"`
	UserID    string `gocti:"user_id"   json:"user_id,omitempty"`
	Timestamp string `gocti:"timestamp" json:"timestamp,omitempty"`
	Comment   string `gocti:"comment"   json:"comment,omitempty"`
}

func (w WorkflowLastHistoryEntry) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(w).IsZero() {
		return []byte("null"), nil
	}

	type tempWorkflowLastHistoryEntry WorkflowLastHistoryEntry

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempWorkflowLastHistoryEntry)(&w))
}

// WorkflowPendingAsyncAction represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type WorkflowPendingAsyncAction struct {
	// WorkflowPendingAsyncAction
	ID             string                `gocti:"id"             json:"id,omitempty"`
	WorkID         string                `gocti:"workId"         json:"workId,omitempty"`
	Type           string                `gocti:"type"           json:"type,omitempty"`
	Status         string                `gocti:"status"         json:"status,omitempty"`
	ProcessedCount int                   `gocti:"processedCount" json:"processedCount,omitempty"`
	ExpectedCount  int                   `gocti:"expectedCount"  json:"expectedCount,omitempty"`
	StartedAt      *time.Time            `gocti:"startedAt"      json:"startedAt,omitempty"`
	LastActivityAt *time.Time            `gocti:"lastActivityAt" json:"lastActivityAt,omitempty"`
	Errors         []WorkflowActionError `gocti:"errors"         json:"errors,omitempty"`
}

func (w WorkflowPendingAsyncAction) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(w).IsZero() {
		return []byte("null"), nil
	}

	type tempWorkflowPendingAsyncAction WorkflowPendingAsyncAction

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempWorkflowPendingAsyncAction)(&w))
}

// WorkflowPendingTransition represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type WorkflowPendingTransition struct {
	// WorkflowPendingTransition
	Event        string                       `gocti:"event"        json:"event,omitempty"`
	ToState      string                       `gocti:"toState"      json:"toState,omitempty"`
	TriggeredAt  *time.Time                   `gocti:"triggeredAt"  json:"triggeredAt,omitempty"`
	AsyncActions []WorkflowPendingAsyncAction `gocti:"asyncActions" json:"asyncActions,omitempty"`
	SyncActions  []WorkflowActionConfig       `gocti:"syncActions"  json:"syncActions,omitempty"`
}

func (w WorkflowPendingTransition) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(w).IsZero() {
		return []byte("null"), nil
	}

	type tempWorkflowPendingTransition WorkflowPendingTransition

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempWorkflowPendingTransition)(&w))
}

// WorkflowTransition represents a GraphQL OBJECT
// Some fields from the OpenCTI schema may be missing
// (See the examples for ways to expand an existing type).
type WorkflowTransition struct {
	...
	Event                            string   `gocti:"event"                            json:"event,omitempty"`
	ToState                          string   `gocti:"toState"                          json:"toState,omitempty"`
	ToStatus                         Status   `gocti:"toStatus"                         json:"toStatus,omitempty"`
	Comment                          string   `gocti:"comment"                          json:"comment,omitempty"`
	Actions                          []string `gocti:"actions"                          json:"actions,omitempty"`
	RequiresShareOrganizationInput   bool     `gocti:"requiresShareOrganizationInput"   json:"requiresShareOrganizationInput,omitempty"`
	RequiresUnshareOrganizationInput bool     `gocti:"requiresUnshareOrganizationInput" json:"requiresUnshareOrganizationInput,omitempty"`
}

func (w WorkflowTransition) MarshalJSON() ([]byte, error) {
	if reflect.ValueOf(w).IsZero() {
		return []byte("null"), nil
	}

	type tempWorkflowTransition WorkflowTransition

	//nolint:wrapcheck // To avoid complete implementation
	return json.Marshal((*tempWorkflowTransition)(&w))
}
...
type Workspace struct {
	...
	UpdatedAt               *time.Time                                `gocti:"updated_at"                json:"updated_at,omitempty"`
	RefreshedAt             *time.Time                                `gocti:"refreshed_at"              json:"refreshed_at,omitempty"`
	RefreshInterval         int                                       `gocti:"refresh_interval"          json:"refresh_interval,omitempty"`
	EditContext             []EditUserContext                         `gocti:"editContext"               json:"editContext,omitempty"`
